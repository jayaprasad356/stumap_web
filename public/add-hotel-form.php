...
if (isset($_POST['btnAdd'])) {
        ...
        if (!empty($name) && !empty($location)) {
            ...
            $sql_query = "INSERT INTO hotels (name,location,image,status)VALUES('$name','$location','$upload_image',1)";
            $db->sql($sql_query);
            $result = $db->getResult();
            if (!empty($result)) {
                $result = 0;
            ...
            if ($result == 1) {
                $error['add_hotel'] = " <section class='content-header'><span class='label label-success'>Hotel Added Successfully</span></section>";
            } else {
                $error['add_hotel'] = " <span class='label label-danger'>Failed add Hotel</span>";
            }
            }
        }
?>
<section class="content-header">
    <h1>Add Hotel <small><a href='hotels.php'> <i class='fa fa-angle-double-left'></i>&nbsp;&nbsp;&nbsp;Back to Hotels</a></small></h1>

    <?php echo isset($error['add_hotel']) ? $error['add_hotel'] : ''; ?>
    <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form name="add_chotel_form" method="post" enctype="multipart/form-data">
                    <div class="box-body">
